...
describe('Place Order - Edit the items', () => {
    ...
    it('Edit the item from checkout page', function () {
        productListingPage.getEditButton()
        cy.info("1. CLICK ON 'EDIT ' BUTTON ")
        cy.wait(3000)

    })

    it('Update the item quantity', function () {
        productListingPage.getAddbutton()
        cy.info("1. CLICK ON 'ADD' BUTTON ")

        productListingPage.getUpdateItembutton()
        cy.info("2. CLICK ON 'UPDATE' BUTTON ")
        cy.wait(3000)
