...
describe('Unsuccessful Order', () => {
    ...
    it('Enter payment details and submit order', function () {
        ...
        cy.info("CARD HOLDER NAME -" + cardholdername + ", CARD NUMBER -" + invalidcardnumber + " , EXPIRY DATE -" + cardexpirydate + " , SECURITY CODE -" + securitycode + " , ADDRESS -" + address + ", CITY -" + city + " , STATE -" + state + " , ZIPCODE -" + zipcode)
        paymentInformationPage.enterCardHolderName(cardholdername)
        paymentInformationPage.enterCardNumber(invalidcardnumber)
    ...
    it('Verify error message', function () {
        paymentInformationPage.switchToPaymentFrame()
        paymentInformationPage.verifyErrorMessage()
    })
