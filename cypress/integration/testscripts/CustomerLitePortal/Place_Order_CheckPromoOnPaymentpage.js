...
describe('Place Order - Verify the promo code in payment page', () => {
    ...
    var cardholdername, cardnumber, invalidcardnumber, cardexpirydate, securitycode, address, city, state, country, zipcode;
    beforeEach(function () {
        cy.fixture('testData').then(function (data) {
            ...
            invalidcardnumber = this.data.invalidcardnumber
    ...
    it('Verify the Product and Checkout from Cart Details page', function () {
        ...
        cy.info("2. CLICK ON 'CHECKOUT BUTTON' " + productname)
    ...
    it('Enter Contact information in Checkout Page', function () {
        ...
        cy.info("2. FILL SOME TEXT IN 'SPECIAL INSTRUCTIONS' TEXTFIELD")
        checkOutPage.enterSpecialInstructions()
        cy.info("3. CHECK AGREE CHECK BOX")
        checkOutPage.clickAcceptCheckBox()

        cy.info("4. CLICK ON 'CONTINUE PAYMENT' BUTTON")
    ...
    it('Apply promo code on payment page and verify it reflected in bill', function () {

        paymentInformationPage.verifyPromoCodeFeatureOnPaymentPage(promocode)
    })
