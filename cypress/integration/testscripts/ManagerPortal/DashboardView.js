...
describe('ORDER DETAILS FOR A STORE IN DASHBOARD', () => {
    ...
    var url, storenumber, storeaddress, phonenumber;
    ...
    it('Verifying Printing count for Upcoming Orders', function () {
        ...
        cy.info("VERIFYING PRINT COUNT DISPLAY FOR UPCOMING ORDERS IN BOTH LEFT AND RIGHT SIDE VIEW HEADER")
    ...
    it('Verifying Printing count for Future Orders', function () {
        ...
        cy.info("VERIFYING PRINT COUNT DISPLAY FOR FUTURE  ORDERS IN BOTH LEFT NAV AND RIGHT SIDE VIEW HEADER")
        dashboardPage.verifyFutureOrdersPrintCount()

    })

    it('Verifying Number of Future Orders displayed ', function () {

        dashboardPage.verifyNumberOfFutureOrdersDisplayed(phonenumber)
